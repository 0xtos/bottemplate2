...
# discord通知用インスタンス作成
discord = Discord(url="https://discord.com/api/webhooks/991815036567814144/XlOdbWoknAXll-8qb4AjTFQNbnWMRrA3fAJwEH6Ee4Nt8W7jebuyPKt0WNR6Zc6hr8eW")
discord.post(content="BYBITBOT" + "起動しました")

# APIを格納
conf = configparser.ConfigParser()
conf.read("config.ini")

apiKey = conf["bybit_testnet"]["access_key"]
secretKey = conf["bybit_testnet"]["secret_key"]

apis = {
    'bybit_testnet': [apiKey, secretKey]
}
...
async def main():
    while True:
        async with pybotters.Client(apis=apis, base_url='https://api-testnet.bybit.com') as client:
            ...
            # discord通知用変数
            #contents = "https://discord.com/api/webhooks/991815036567814144/XlOdbWoknAXll-8qb4AjTFQNbnWMRrA3fAJwEH6Ee4Nt8W7jebuyPKt0WNR6Zc6hr8eW"
